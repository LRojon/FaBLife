...
const StartingLifeModal = ({ player, format, onClose, onSelectLife }) => {
  ...
  const desktopAlignClass = isPlayer2 ? 'md:justify-end md:pr-8' : 'md:justify-start md:pl-8';
  
  return (
    <div className={`fixed inset-0 bg-black bg-opacity-75 z-50 flex ${positionClass} justify-center p-4 md:items-center md:pt-0 md:pb-0 ${desktopAlignClass}`}>
